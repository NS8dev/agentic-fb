...
export const PATTERN_PRESETS_MORE: PatternPreset[] = [
  ...
  // --- NEW HYPER-REALISTIC PATTERNS ---
  { id: "damask", label: "Damask", svg: (c, bg) => wrap(120, `<path d="M60 20 Q80 0 100 20 Q120 40 100 60 Q80 80 60 60 Q40 80 20 60 Q0 40 20 20 Q40 0 60 20 Z" fill="none" stroke="${c}" stroke-width="2"/><path d="M60 40 Q70 30 80 40 T100 40" fill="none" stroke="${c}" stroke-width="1" opacity="0.5"/>`, bg) },
  { id: "baroque", label: "Baroque Scroll", svg: (c, bg) => wrap(100, `<path d="M20 80 Q40 80 40 60 Q40 40 20 40 Q0 40 0 60 Q0 80 20 80 M40 60 Q40 20 80 20 Q100 20 100 40" fill="none" stroke="${c}" stroke-width="3" stroke-linecap="round"/>`, bg) },
  { id: "camo", label: "Camouflage", svg: (c, bg) => wrap(100, `<path d="M10 10 Q30 5 40 20 T70 10 T90 30 T70 60 T40 50 T10 70 Z" fill="${c}" opacity="0.6"/><path d="M50 50 Q70 45 80 60 T100 50 T80 90 T50 80 Z" fill="${c}" opacity="0.4"/>`, bg) },
  { id: "geo-mesh", label: "Geometric Mesh", svg: (c, bg) => wrap(60, `<path d="M0 0 L30 15 L60 0 L45 30 L60 60 L30 45 L0 60 L15 30 Z" fill="none" stroke="${c}" stroke-width="1.5"/>`, bg) },
  { id: "lace", label: "Lace Pattern", svg: (c, bg) => wrap(80, `<circle cx="40" cy="40" r="35" fill="none" stroke="${c}" stroke-width="1" stroke-dasharray="2 2"/><circle cx="40" cy="40" r="25" fill="none" stroke="${c}" stroke-width="2" opacity="0.5"/>`, bg) },
];
